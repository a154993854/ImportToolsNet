...
using TransToolsNet.Common;

namespace TransToolsNet.Data.Common
{
    /// <summary>
    /// OracleServer数据访问帮助类
    /// </summary>
    public sealed class SqlHelper
    {
        ...
        {
            if (GetConnectionStr() == null || GetConnectionStr().Length == 0) throw new ArgumentNullException("connectionString");
        ...
        /// <param>OracleParamter参数数组</param>
        /// <returns>返回影响的行数</returns>
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(transaction.Connection, spName, false);
                // 给存储过程参数赋值
                AssignParameterValues(commandParameters, parameterValues);
                // 调用重载方法
        ...
        /// <param>命令类型 (存储过程,命令文本或其它)</param>
        /// <param>存储过程名称或T-SQL语句</param>
        /// <param>OracleParamters参数数组</param>
        ...
        /// <param>存储过程名或T-SQL语句</param>
        /// <returns>返回一个包含结果集的DataSet</returns>
        public static DataSet ExecuteDataset(SqlTransaction transaction, CommandType commandType, string commandText, out SqlCommand cmd)
        {
            return ExecuteDataset(transaction, commandType, commandText, out cmd, (SqlParameter[])null);
        }
        ...
        public static DataSet ExecuteDataset(SqlTransaction transaction,
            CommandType commandType, string commandText, out SqlCommand cmd, params SqlParameter[] commandParameters)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            // 预处理
        ...
        /// <param>分配给存储过程输入参数的对象数组</param>
        /// <returns>返回一个包含结果集的DataSet</returns>
        public static DataSet ExecuteDataset(SqlTransaction transaction, string spName, out SqlCommand cmd, params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                // 给存储过程参数分配值
                AssignParameterValues(commandParameters, parameterValues);
                return ExecuteDataset(transaction, CommandType.StoredProcedure, spName, out cmd, commandParameters);
            }
            else
            {
                return ExecuteDataset(transaction, CommandType.StoredProcedure, spName, out cmd);
            }
        }
        ...
        private static SqlDataReader ExecuteReader(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, SqlConnectionOwnership connectionOwnership)
        {
            ...
            try
            {
                ...
                // then the OracleReader can磘 set its values. 
        ...
        /// <param>命令类型 (存储过程,命令文本或其它)</param>
        /// <param>存储过程名或T-SQL语句</param>
        /// <param>OracleParamter参数数组(new SqlParameter("@prodid", 24))</param>
        /// <returns>返回包含结果集的SqlDataReader</returns>
        ...
        /// <param>命令类型 (存储过程,命令文本或其它)</param>
        /// <param>存储过程名称或T-SQL语句</param>
        /// <param>分配给命令的OracleParamter参数数组</param>
        /// <returns>返回包含结果集的SqlDataReader</returns>
        ...
        //        return SqlHelper.ExecuteNonQuery(GetConnectionStr(), CommandType.StoredProcedure, spName, commandParameters);
        //    }
        //    else
        //    {
        //        return SqlHelper.ExecuteNonQuery(GetConnectionStr(), CommandType.StoredProcedure, spName);
        //    }
        //}
        ...
        //        return SqlHelper.ExecuteDataset(GetConnectionStr(), CommandType.StoredProcedure, spName, commandParameters);
        //    }
        //    else
        //    {
        //        return SqlHelper.ExecuteDataset(GetConnectionStr(), CommandType.StoredProcedure, spName);
        //    }
        //}
        ...
        //        return SqlHelper.ExecuteReader(GetConnectionStr(), CommandType.StoredProcedure, spName, commandParameters);
        //    }
        //    else
        //    {
        //        return SqlHelper.ExecuteReader(GetConnectionStr(), CommandType.StoredProcedure, spName);
        //    }
        //}
        ...
        //        return SqlHelper.ExecuteScalar(GetConnectionStr(), CommandType.StoredProcedure, spName, commandParameters);
        //    }
        //    else
        //    {
        //        return SqlHelper.ExecuteScalar(GetConnectionStr(), CommandType.StoredProcedure, spName);
        //    }
        //}
        ...
        {
            string encryptString = ConfigurationManager.ConnectionStrings["TransConnSQLStr"].ConnectionString;

            string temp = "";
            if (!string.IsNullOrEmpty(encryptString))
            {
                int passwordIndex = encryptString.ToLower().IndexOf("password=");

                if (passwordIndex >= 0)
                {
                    temp = encryptString.Substring(passwordIndex);
                    if (temp.IndexOf(";") > 0)
                    {
                    ...
                    encryptString = encryptString.Replace(temp, Security.DecryptDES(temp, "12345679"));
                }
            }
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        {
            if (SqlHelper.GetConnectionStr() == null || SqlHelper.GetConnectionStr().Length == 0) throw new ArgumentNullException("SqlHelper.GetConnectionStr()");
            if (commandText == null || commandText.Length == 0) throw new ArgumentNullException("commandText");
            string hashKey = SqlHelper.GetConnectionStr() + ":" + commandText;
        ...
        public static SqlParameter[] GetSpParameterSet(string spName, bool includeReturnValueParameter)
        {
            if (SqlHelper.GetConnectionStr() == null || SqlHelper.GetConnectionStr().Length == 0) throw new ArgumentNullException("SqlHelper.GetConnectionStr()");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            using (SqlConnection connection = new SqlConnection(SqlHelper.GetConnectionStr()))
            {
